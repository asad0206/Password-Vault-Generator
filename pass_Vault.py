...
from pass_gen import passGenerator
...
def firstTimeScreen():
    ...
    def savePassword():
        if txt.get() == txt1.get():
            ...
            lbl1.config(text="Passwords dont match")
...
def loginScreen():
    ...
    def checkPassword():
        ...
        if password:
            ...
            txt.delete(0, "end")
            lbl1.config(text="Wrong Passowrd")
...
def vaultScreen():
    ...
    def addEntry():
        ...
        insert_fields = """INSERT INTO vault(platform, account, paassword) VALUES(?,?,?)"""
    ...
    my_canvas.pack(side=LEFT, fill=BOTH, exapnd=1)
